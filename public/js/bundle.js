...
var setAlert = function setAlert(type, message) {
  hideAlert();
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.setAlert)('success', 'Logged in successfully!');
          ...
          case 7:
            ...
            (0, _alert.setAlert)('error', _context.t0.response.data.message);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.setAlert)('success', 'Logged out successfully!');
              location.assign('/');
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alert.setAlert)('error', 'Could not log out. Try again!');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic21hbmFuMyIsImEiOiJja2FqcHNqZmMwY3k0MnRtbmUyaTA3c3k0In0.7AdKPQUF4xS4_WlTI1eO6Q';
...
},{}],"updateDetails.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.setAlert)('success', 'Updated details!');
              setTimeout(function () {
...
var _updateDetails = require("./updateDetails");
...
if (settingsForm) {
  settingsForm.addEventListener('submit', function (event) {
    ...
    (0, _updateDetails.updateDetails)(form, 'settings');
  });
}
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              event.preventDefault(); // Notify user that password is updating
              ...
              _context.next = 7;
              return (0, _updateDetails.updateDetails)({
            ...
            case 7:
              ...
              document.getElementById('password-confirm').value = ''; // Set button text back to default
